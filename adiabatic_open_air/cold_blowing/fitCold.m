function BiotFunc = fitCold(stringPr,stringG,Gamma,Re)
GammaA = load(strcat('A0toA5_Cold_a0Fit_',stringPr,'_',stringG,'.dat'));
GammaB = load(strcat('A0toA5_Cold_a1Fit_',stringPr,'_',stringG,'.dat'));
GammaC = load(strcat('A0toA5_Cold_a2Fit_',stringPr,'_',stringG,'.dat'));
...
BiotFunc = @(x) a0fitted + a1fitted.*abs(x+0.5).^a2fitted;
end