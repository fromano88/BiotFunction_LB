function BiotFunc = fitTop(stringPr,stringG,Gamma,Re)
GammaA = load(strcat('A0toA5_Top_a0Fit_',stringPr,'_',stringG,'.dat'));
GammaB = load(strcat('A0toA5_Top_a1Fit_',stringPr,'_',stringG,'.dat'));
GammaC = load(strcat('A0toA5_Top_a2Fit_',stringPr,'_',stringG,'.dat'));
